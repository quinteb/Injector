...
namespace yourInjector
{
    class NamedPipes
    {
        public static string luapipename = "My-exploit-name"; // your pipe name you can find it in the main.cpp file
        ...
        public static void LuaPipe(string script)
        {
            ...
            {
                MessageBox.Show("Inject " + Functions.exploitdllname + " before Using this!", "Error");
                return;
            }
        }
    }
